...
if nz != 0:
  ...
  area_tot = (xmax-xmin)*(ymax-ymin)
  xsize = (xmax - xmin)/nx
  ysize = (ymax - ymin)/ny
  area_grid = xsize*ysize
  states = np.loadtxt("GRID_ASSIGNATION", dtype=int,usecols=(2,))
  densit = np.loadtxt("GRID_ASSIGNATION", dtype=float,usecols=(3,))
...
if nz:
  ...
  lines1 = np.loadtxt('GRID_ASSIGNATION', usecols=(0,1), dtype=float)
  lines2 = np.loadtxt('GRID_ASSIGNATION', usecols=(2,), dtype=int)
